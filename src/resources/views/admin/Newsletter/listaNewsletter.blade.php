                  ...
                  <div class="card-header">
                    <div class="row g-2 align-items-center">
                      <div class="col-12 col-md-4">
                        <h3 class="card-title">Newsletter cadastradas</h3>
                      </div>
                ...
                <div class="modal-content">
                  <form>
                    <div class="modal-header">
                      <h5 class="modal-title" id="modal-add-newsletter-label">Add new newsletter</h5>
                      <button
                        type="button"
                        class="btn-close"
                    ...
                    <div class="modal-body">
                      ...
                      <div class="mb-3">
                        <label for="new-newletter-email" class="form-label"> Email address </label>
                        <input
                          type="email"
                          class="form-control"
                          id="new-newsletter-email"
            ...
            >
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p class="mb-0">
                      Are you sure you want to delete this newsletter? All content owned by the account
