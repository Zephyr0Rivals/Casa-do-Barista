                            ...
                            <td class="text-end">
                              <div class="btn-group btn-group-sm">
                                ...
                                <button
                                  ...
                                  data-bs-toggle="modal"
                                  data-bs-target="#modal-delete-Venda"
                                  aria-label="Deletar"
                                >
                ...
                <div class="modal-content">
                  <form>
                    <div class="modal-header">
                      <h5 class="modal-title" id="modal-add-Venda-label">Add new Venda</h5>
                      <button
                        type="button"
                        class="btn-close"
                    ...
                    <div class="modal-body">
                      ...
                      <div class="mb-3">
                        <label for="new-Venda-email" class="form-label"> Email address </label>
                        <input
                          type="email"
                          class="form-control"
                          id="new-Venda-email"
            ...
            >
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p class="mb-0">
                      Are you sure you want to delete this Venda? All content owned by the account
